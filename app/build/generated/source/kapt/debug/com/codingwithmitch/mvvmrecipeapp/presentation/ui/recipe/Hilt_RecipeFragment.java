...
public abstract class Hilt_RecipeFragment extends Fragment implements GeneratedComponentManagerHolder {
  ...
  Hilt_RecipeFragment(int contentLayoutId) {
  ...
  protected void inject() {
    if (!injected) {
      injected = true;
      ((RecipeFragment_GeneratedInjector) this.generatedComponent()).injectRecipeFragment(UnsafeCasts.<RecipeFragment>unsafeCast(this));
    }
  }
